...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/francislagares/food-delivery-app/Tests?style=for-the-badge&labelColor=black&logo=github)
...
- Clone the repo
  ...
  ```bash
  $ git clone https://github.com/francislagares/food-delivery-app.git
  ```
